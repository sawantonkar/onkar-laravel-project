        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item dropdown">
            ...
            >
              ...
              <span class="text text-capitalize" >{{Session::get('student_firstname')}}</span>
            </a>
            <div
    ...
    <div class="wrapper d-flex">
      <div class="sideMenu bg-mattBlackLight">
        <div class="sidebar">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a href="/studenthome" class="nav-link px-2">
                <i class="material-icons icon">
                  dashboard
                </i>
            ...
            <li class="nav-item">
              <a href="/studentViewResult" class="nav-link px-2">
                <i class="material-icons icon">
                library_books
                </i>
