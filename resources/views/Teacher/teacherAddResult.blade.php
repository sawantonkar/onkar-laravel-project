...
<div class="content">
        <main>
          ...
          <form action="/teacherInsertResult" method="post" onsubmit="return validation()">
          @csrf
          <div class="row">
              <div class="col-md-4 offset-md-4">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control text-capitalize" name="student_email" id="stu" value="{{old('student_email')}}">
                    <option value="-- Select Student --">-- Select Student --</option>
                        @foreach($student as $stud)
                        <option value="{{$stud->email}}">{{$stud->firstname}} {{$stud->lastname}}</option>
                        @endforeach
                    </select>
                    ...
                    <div class="bg-mattBlackLight my-2 p-3">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="subject1_marks" placeholder="Enter marks" id="gainedmarks1" autocomplete="off" value="{{old('subject1_marks')}}"><br>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="subject2_marks" placeholder="Enter marks" id="gainedmarks2" autocomplete="off" value="{{old('subject2_marks')}}"><br>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="subject3_marks" placeholder="Enter marks" id="gainedmarks3" autocomplete="off" value="{{old('subject3_marks')}}"><br>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="subject4_marks" placeholder="Enter marks" id="gainedmarks4" autocomplete="off" value="{{old('subject4_marks')}}"><br>
            ...
            <input type="hidden" name="student_semester" value="{{$subject->subject_semester}}">
            </form>
          </div>
        </main>
 </div>
