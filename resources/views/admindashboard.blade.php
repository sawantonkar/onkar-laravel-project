        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item dropdown">
            ...
            >
              ...
              <span class="text">{{Session::get('admin')}}</span>
            </a>
            <div
    ...
    <div class="wrapper d-flex">
      <div class="sideMenu bg-mattBlackLight">
        <div class="sidebar">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a href="/adminhome" class="nav-link px-2">
                <i class="material-icons icon">
                  dashboard
                </i>
            ...
            <li class="nav-item">
              <a href="/adminViewTeacher" class="nav-link px-2">
                <i class="material-icons icon">
                  person
                </i>
            ...
            <li class="nav-item">
              <a href="/adminViewStudent" class="nav-link px-2">
                <i class="material-icons icon"> school </i
                ><span class="text">Student</span></a
              >
            </li>
            <li class="nav-item">
              <a href="/adminViewSemester" class="nav-link px-2">
                <i class="material-icons icon">
                  assignment
                </i>
            ...
            <li class="nav-item">
              <a href="/adminViewSubject" class="nav-link px-2">
                <i class="material-icons icon">
                library_books
                </i>
